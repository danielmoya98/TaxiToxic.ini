...
(function( $, window, document, undefined ) {
	 ...
	 * parameters can have multiple Conductores, and backwards compatibility.
	 *
	 * @param {object} oSettings dataTables settings object
	 ...
	 * take several different Conductores for ease of use.
	 *
	...
	DataTable.defaults.column = {
		 ...
		 *    // (which has both Conductores) is used for filtering for if a user inputs either format, while
